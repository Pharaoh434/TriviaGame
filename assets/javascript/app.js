...
alert("You have 15 seconds,Begin")
function run() {
   ...
   function decrement() {
    ...
    const myQuestions = [
      {
        question: "How many kids did Leia Solo have?",
        answers: {
          a: "One",
          b: "Three",
          c: "All of Them",
      ...
      {
        question: "How fast could Han Solo finish the kessel run?",
        answers: {
          a: "Hella",
          b: "Pretty damn",
          c: "In under twelve parsecs",
          d: "Too fast"
        },
        correctAnswer: "c"
      }
